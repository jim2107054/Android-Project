...
public class CityDetailsActivityHamburg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_city_details_hamburg);
...
//                cityName.setText("Abul's 3rd House.");
                    ...
                    ImageView house1Image = findViewById(R.id.image_b1);
                    ImageView house2Image = findViewById(R.id.image_m1);
                    ImageView house3Image = findViewById(R.id.image_h1);

                    // OnClickListeners for each image
                    house1Image.setOnClickListener(v -> {
                        Intent intent = new Intent(CityDetailsActivityHamburg.this, House1Activity.class);
                        startActivity(intent);
                    });

                    house2Image.setOnClickListener(v -> {
                        Intent intent = new Intent(CityDetailsActivityHamburg.this, House2Activity.class);
                        startActivity(intent);
                    });

                    house3Image.setOnClickListener(v -> {
                        Intent intent = new Intent(CityDetailsActivityHamburg.this, House3Activity.class);
                        startActivity(intent);
                    });
                }
            }
